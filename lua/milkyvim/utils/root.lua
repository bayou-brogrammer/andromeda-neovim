...
function M.setup()
	vim.api.nvim_create_user_command("LazyRoot", function()
		Utils.root.info()
	end, { desc = "MilkyVim roots for the current buffer" })

	vim.api.nvim_create_autocmd({ "LspAttach", "BufWritePost" }, {
		group = vim.api.nvim_create_augroup("milkyvim_root_cache", { clear = true }),
...
function M.info()
	...
	require("milkyvim.utils").info(lines, { title = "MilkyVim Roots" })
