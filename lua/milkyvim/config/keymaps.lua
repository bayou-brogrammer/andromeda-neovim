...
map("n", "<leader>ul", function() Utils.toggle.number() end, { desc = "Toggle Line Numbers" })
map("n", "<leader>ud", function() Utils.toggle.diagnostics() end, { desc = "Toggle Diagnostics" })
map("n", "<leader>uf", function() Utils.format.toggle() end, { desc = "Toggle auto format (global)" })
map("n", "<leader>uF", function() Utils.format.toggle(true) end, { desc = "Toggle auto format (buffer)" })
map("n", "<leader>uL", function() Utils.toggle("relativenumber") end, { desc = "Toggle Relative Line Numbers" })
...
-- map("n", "<leader>fT", function() Utils.terminal() end, { desc = "Terminal (cwd)" })
